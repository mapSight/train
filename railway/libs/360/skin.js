...
// Generated 周三 9月 19 11:37:42 2018
...
function pano2vrSkin(player,base) {
	...
	this.preloadImages=function() {
		...
		preLoadImg.src=basePath + 'image/control/left__o.png';
		preLoadImg.src=basePath + 'image/control/right__o.png';
		preLoadImg.src=basePath + 'image/control/up__o.png';
		preLoadImg.src=basePath + 'image/control/down__o.png';
		preLoadImg.src=basePath + 'image/control/zoom_in__o.png';
		preLoadImg.src=basePath + 'image/control/zoom_out__o.png';
		preLoadImg.src=basePath + 'image/control/auto_rotate__o.png';
		preLoadImg.src=basePath + 'image/control/fullscreen__o.png';
	}
	...
	this.addSkin=function() {
		...
		this._loading_image__img.setAttribute('src',basePath + 'image/control/loading_image.png');
		...
		this._loading_close__img.setAttribute('src',basePath + 'image/control/loading_close.png');
		...
		this._left__img.setAttribute('src',basePath + 'image/control/left.png');
		...
		this._left.onmouseover=function () {
			me._left__img.src=basePath + 'image/control/left__o.png';
		}
		this._left.onmouseout=function () {
			me._left__img.src=basePath + 'image/control/left.png';
		...
		this._right__img.setAttribute('src',basePath + 'image/control/right.png');
		...
		this._right.onmouseover=function () {
			me._right__img.src=basePath + 'image/control/right__o.png';
		}
		this._right.onmouseout=function () {
			me._right__img.src=basePath + 'image/control/right.png';
		...
		this._up__img.setAttribute('src',basePath + 'image/control/up.png');
		...
		this._up.onmouseover=function () {
			me._up__img.src=basePath + 'image/control/up__o.png';
		}
		this._up.onmouseout=function () {
			me._up__img.src=basePath + 'image/control/up.png';
		...
		this._down__img.setAttribute('src',basePath + 'image/control/down.png');
		...
		this._down.onmouseover=function () {
			me._down__img.src=basePath + 'image/control/down__o.png';
		}
		this._down.onmouseout=function () {
			me._down__img.src=basePath + 'image/control/down.png';
		...
		this._zoom_in__img.setAttribute('src',basePath + 'image/control/zoom_in.png');
		...
		this._zoom_in.onmouseover=function () {
			me._zoom_in__img.src=basePath + 'image/control/zoom_in__o.png';
		}
		this._zoom_in.onmouseout=function () {
			me._zoom_in__img.src=basePath + 'image/control/zoom_in.png';
		...
		this._zoom_out__img.setAttribute('src',basePath + 'image/control/zoom_out.png');
		...
		this._zoom_out.onmouseover=function () {
			me._zoom_out__img.src=basePath + 'image/control/zoom_out__o.png';
		}
		this._zoom_out.onmouseout=function () {
			me._zoom_out__img.src=basePath + 'image/control/zoom_out.png';
		...
		this._auto_rotate__img.setAttribute('src',basePath + 'image/control/auto_rotate.png');
		...
		this._auto_rotate.onmouseover=function () {
			me._auto_rotate__img.src=basePath + 'image/control/auto_rotate__o.png';
		}
		this._auto_rotate.onmouseout=function () {
			me._auto_rotate__img.src=basePath + 'image/control/auto_rotate.png';
		}
		...
		this._fullscreen__img.setAttribute('src',basePath + 'image/control/fullscreen.png');
		...
		this._fullscreen.onmouseover=function () {
			me._fullscreen__img.src=basePath + 'image/control/fullscreen__o.png';
		}
		this._fullscreen.onmouseout=function () {
			me._fullscreen__img.src=basePath + 'image/control/fullscreen.png';
		}
		...
		this._radar__img.setAttribute('src',basePath + 'image/control/radar.png');
		...
		this._radar_beam__img.setAttribute('src',basePath + 'image/control/radar_beam.png');
		...
		this._radar_dot__img.setAttribute('src',basePath + 'image/control/radar_dot.png');
